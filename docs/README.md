  ...
  <div class="container is-max-desktop">
    <div class="hero-body has-text-centered">
      ...
      <video poster="" id="tree" autoplay controls muted loop height="100%" preload="metadata">
        ...
        <source src="static/videos/ActiveBinPickingRealExptOnly_lowR.mp4" type="video/mp4">
      </video>
      <!-- TODO: Replace with your video description -->
      <h2 class="subtitle has-text-centered">
        A real experiment to show our high-speed active vision bin picking system and its unique sensing scheme (Grasping is not focused in our paper and experiment) 
      </h2>
    </div>
  </div>
</section>
